...
a helpful addition to the `party-bus`, enabling easy automatic log generation.
...
[![clown-car v0.1.4](https://img.shields.io/badge/v0.1.4-purple?label=version)](//github.com/brekk/clown-car) <!-- $MADLIB.json.version -->
